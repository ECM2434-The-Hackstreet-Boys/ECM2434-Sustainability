...
CMD python manage.py makemigrations; python manage.py migrate; python manage.py collectstatic --noinput; python manage.py import_quiz; gunicorn --bind 0.0.0.0:8000 SustainabilityApp.wsgi:application
